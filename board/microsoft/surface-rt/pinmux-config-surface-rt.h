...
static struct pmux_pingrp_config tegra3_pinmux_common[] = {
	...
	//DEFAULT_PINMUX(PV1, RSVD1, NORMAL, TRISTATE, INPUT),
	...
	DEFAULT_PINMUX(HDMI_INT_PN7, HDMI, NORMAL, TRISTATE, INPUT),
	...
	DEFAULT_PINMUX(PU5, PWM2, DOWN, NORMAL, INPUT),
	...
	DEFAULT_PINMUX(GMI_CS2_N_PK3, RSVD1, UP, NORMAL, INPUT), 

	//DEFAULT_PINMUX(GMI_CS4_N_PK2, NAND, NORMAL, NORMAL, OUTPUT), //CS5 not exist
	//DEFAULT_PINMUX(GMI_CS6_N_PI3, NAND, UP, NORMAL, INPUT),
	...
	//DEFAULT_PINMUX(GMI_AD15_PH7, NAND, NORMAL, NORMAL, OUTPUT),
	...
	//DEFAULT_PINMUX(GMI_RST_N_PI4, GMI, NORMAL, TRISTATE, OUTPUT),
	...
	LV_PINMUX(SDMMC4_RST_N_PCC3, RSVD1, UP, NORMAL, INPUT, DISABLE, DISABLE),
	...
	DEFAULT_PINMUX(KB_ROW14_PS6, SDMMC2, NORMAL, TRISTATE, INPUT),
	DEFAULT_PINMUX(KB_ROW15_PS7, SDMMC2, NORMAL, TRISTATE, INPUT),
	...
	//DEFAULT_PINMUX(CORE_PWR_REQ, SYSCLK, NORMAL, NORMAL, OUTPUT),
	//DEFAULT_PINMUX(CPU_PWR_REQ, SYSCLK, NORMAL, NORMAL, OUTPUT),
	//DEFAULT_PINMUX(PWR_INT_N, SYSCLK, NORMAL, NORMAL, OUTPUT),
	//DEFAULT_PINMUX(CLK_32K_IN, SYSCLK, NORMAL, NORMAL, OUTPUT),
	...
	//DEFAULT_PINMUX(SPI2_MOSI_PX0, SPI6, UP, NORMAL, INPUT),
	//DEFAULT_PINMUX(SPI2_MISO_PX1, SPI6, NORMAL, NORMAL, INPUT),
	DEFAULT_PINMUX(SPI2_CS1_N_PW2, SPI6, UP, NORMAL, INPUT),
	...
	DEFAULT_PINMUX(SPI1_CS0_N_PX6, GMI, NORMAL, TRISTATE, INPUT),
